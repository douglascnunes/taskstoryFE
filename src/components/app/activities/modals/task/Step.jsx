  ...
  return (
    <div className={styles.stepContainer}>
      ...
      <div className={styles.actions}>
        <button className={`${styles.removeButton} button`} onClick={() => handleMoveStep('up')}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18" />
          </svg>
        </button>
        <button className={`${styles.removeButton} button`} onClick={() => handleMoveStep('down')} title="Mover para baixo" >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" />
          </svg>
        </button>
        <button className={`${styles.removeButton} button`} onClick={() => removeTaskStep(step.index, step.id)} title="Remover"       >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
